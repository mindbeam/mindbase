...
pub fn run(mb: MindBase, keymanager: KeyManager, cmd: Command) {
    match cmd {
...
fn create(mb: MindBase, keymanager: KeyManager) {
...
fn login(mb: MindBase, keymanager: KeyManager) {
    let (email, password) = get_email_password();

    unimplemented!()
}

fn logout(mb: MindBase, keymanager: KeyManager) {
    let (email, password) = get_email_password();

    unimplemented!()
}

fn get_email_password() -> (String, String) {
